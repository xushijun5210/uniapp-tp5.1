<template>
    <div>
        ...
        <V5Dialog @success="onSuccess" :mournful="mournful" v-bind:lang="lang" ref="dialog" v-bind:host="host" v-bind:token="token" v-bind:ssl="ssl" :trustLevel="trustLevel"></V5Dialog>
